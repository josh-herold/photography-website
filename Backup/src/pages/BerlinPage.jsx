...
const BerlinPage = () => {
  ...
  useEffect(() => {
    fetch('/photography/images/berlin-images.json')
      .then(res => res.json())
    ...
    >
      <div>
        <div className="berlin-head">
          <div className="berlin-uber">BERLIN</div>
          <div className="berlin-gallery-container">
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div
                {...handlers}
                className="berlin-lightbox-content"
                onClick={(e) => {
              ...
              >
                ...
                <AnimatePresence mode="wait">
                  <motion.img
                    ...
                    className="berlin-lightbox-image"
